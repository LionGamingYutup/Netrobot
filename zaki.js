...
//Gambar
let zaki = fs.readFileSync('./media/Laki.jpg')
...
//Fake Reply Group
	const reply = (teks) => {
            Zaki.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/Laki.jpg`),"sourceUrl": "https://chat.whatsapp.com/E14rIyYMuovIfkskhi5QN9"}}}, { quoted: m})
        }
        
        const reply1 = (teks) => {
            Zaki.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Subscribe Bot's Official YT Channel`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/Laki.jpg`),"sourceUrl": "https://m.youtube.com/channel/UCHdipvk52k43KsPRenGpD0w"}}}, { quoted: m})
        }
try {
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
	    ...
	    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                Zaki.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/67c8b66f3e85bf90cb80d.jpg' }, caption: `*── 「 DONATE 」 ──*\n\n_Kalian Bisa Dukung Bot Lewat Donasi Ke :_\n _》Dana :082138356143 _\n _》Gopay : 082136821559_\n _》Pulsa : 082138356143 ( Telkomsel )_\n\n_Donate Kalian Sangat Berarti._\n\n_Contact person Owner:_\n_wa.me/6282136821559_` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      fatihgans = fs.readFileSync('./media/Laki.jpg')
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'FN:KiZakiXD\n'
    + 'ORG:LionGamingYT;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6282136821559:+62 821-3682-1559\n' 
    + 'item1.X-ABLabel:Creator NetroBot - MDt\n'
    + 'item2.EMAIL;type=INTERNET:realmsmcpe71@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/msultanutomo\n'
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            locationMessage: {
                            jpegThumbnail: fs.readFileSync('./media/Laki.jpg')},
                            hydratedFooterText: `NetroBot By Sultan_Gans | © 2022`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YouTube',
                                    url: 'https://youtube.com/channel/UCbPD6WnYyXsS5EWNlc-XRVw'
                                }
                            }, {
                            	urlButton: {
                                displayText: 'Group',
                                    url: 'https://chat.whatsapp.com/B8f4cXJzMvk1qaf0njrYxR'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Menu',
...
break
           case 'allmenu': case 'bot': case 'command': case 'listmenu':{
                anu = 
