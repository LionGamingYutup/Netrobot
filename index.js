...
async function startZaki() {
    ...
    const Zaki = ZakiConnect({
        ...
        browser: ['LionGamingYT','Safari','1.0.0'],
        auth: state,
        version
    })
    ...
    Zaki.sendMessage(`6282136821559@s.whatsapp.net`, {text: `*Report Bot:* Someone Called Bot`})
    await sleep(8000)
